    ...
    <div className="w-full flex-1 p-6 md:p-8 font-sans text-slate-900 max-w-[1400px] mx-auto">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        ...
        <button 
          ...
          className="relative group overflow-hidden flex items-center gap-2 px-5 py-2.5 bg-slate-900 text-white text-sm font-semibold rounded-lg hover:bg-slate-800 transition-all shadow-[0_4px_12px_rgba(0,0,0,0.1)] active:scale-[0.98] border border-slate-900/50"
        >
      ...
      <div className="w-full bg-white border border-slate-200/80 rounded-t-xl p-3 flex items-center justify-between shadow-sm">
        <div className="flex items-center gap-3">
          <div className="relative">
            ...
            <input type="text" placeholder="Cari dokumen..." className="pl-9 pr-4 py-1.5 text-sm font-medium bg-slate-50 border border-slate-200 rounded-md outline-none focus:ring-2 focus:ring-slate-200 w-64 placeholder-slate-400 text-slate-800" />
          </div>
          <button className="px-3 py-1.5 text-sm font-medium text-slate-600 bg-white border border-slate-200 rounded-md hover:bg-slate-50 shadow-sm flex items-center gap-2">
      ...
      <div className="w-full bg-white border-x border-b border-slate-200/80 rounded-b-xl shadow-sm overflow-hidden">
        {isLoading ? (
                ...
                {articles.map((a) => (
                  <tr key={a.id} className="hover:bg-slate-50/80 transition-colors group">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className="inline-flex items-center px-2.5 py-1 rounded-md text-[11px] font-semibold bg-slate-100 text-slate-700 border border-slate-200/80">
                        {a.kategori}
                      </span>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right">
                      <div className="flex justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                        <button 
                          ...
                          className="p-1.5 text-slate-400 hover:text-blue-600 hover:bg-blue-50 rounded-md transition-all border border-transparent hover:border-blue-100 shadow-sm"
                          title="Edit Dokumen"
                        >
                        ...
                        {userRole === 'publisher' && (
                          <button 
                            ...
                            className="p-1.5 text-slate-400 hover:text-red-600 hover:bg-red-50 rounded-md transition-all border border-transparent hover:border-red-100 shadow-sm"
                            title="Hapus Dokumen"
                          >
