  ...
  return (
    ...
    >
      <div className="max-w-[1400px] mx-auto px-6 md:px-16">
        <div className="mb-16">
          <h2 className="text-4xl md:text-5xl font-heading font-bold text-charcoal-ink tracking-tight mb-4">
            Target Lulusan.
          </h2>
          <p className="text-muted-steel font-body max-w-2xl text-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {targetLulusan.map((item, index) => (
            ...
            >
              <div className="text-6xl font-heading font-light text-accent-sage/20 group-hover:text-accent-gold/40 transition-colors duration-500">
                0{index + 1}
              </div>
              <div>
                <h3 className="text-2xl font-heading font-bold text-charcoal-ink mb-4 group-hover:text-accent-sage transition-colors duration-300">
                  {item.judul}
                </h3>
                <p className="text-muted-steel leading-relaxed font-body">
                  {item.deskripsi}
                </p>
              </div>
            </div>
